...
@cython.locals(stageDict=dict, stageList=list, reader=object, line=str, job=object, stage=dict)
cpdef void sortStages(str data, str stat)

@cython.locals(specialDict=dict, specialList=list, reader=object, line=str, job=object, special=dict)
