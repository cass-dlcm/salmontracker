...
@cython.locals(statArr=list, sumVal=cython.double, maxVal=cython.double, minVal=cython.double, vals=list, count=cython.double, line=str, job=object, val=cython.double)
cpdef tuple statSummary(str data, str stat)

@cython.locals(sumVal=cython.double, count=cython.double, line=str, job=object)
...
@cython.locals(result=str, stats=list, reader=object, clearCount=cython.double, waveTwoCount=cython.double, waveOneCount=cython.double, sumVal=cython.double[6], maxVal=cython.double[6], minVal=cython.double[6], vals=list, count=cython.int, line=str, job=object, i=cython.int, val=cython.double)
...
@cython.locals(count=cython.int, reader=object, line=str)
...
@cython.locals(reader=object, results=list, line=str, job=object)
...
@cython.locals(jobs=list, reader=object, line=str)
